  ...
  <div>
    <div class="mb-6 flex items-center justify-between">
      <div class="animate-fade-in">
        <h1
          class="text-3xl font-bold bg-gradient-to-r from-primary to-violet-600 bg-clip-text text-transparent"
        >
          Payments
        </h1>
    ...
    <div class="mb-6 animate-fade-up" style="animation-delay: 0.1s">
      <Card>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
          ...
          <!-- Amount Range -->
          <div>
            <label class="text-xs text-muted-foreground mb-1 block">Min Amount</label>
            <input
          ...
          <div>
            <label class="text-xs text-muted-foreground mb-1 block">Max Amount</label>
            <input
...
const { getPayments, exportPayments } = usePayment()
...
const handleExport = async () => {
  ...
  try {
    ...
    uiStore.showToast('Export downloaded successfully', 'success')
  } catch {
